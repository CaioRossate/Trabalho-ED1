...
/**
 * @file retangulo.h
 * @brief Definições do TAD Retângulo (formato inspirado em SVG).
 * 
 * @details
...
typedef void* RETANGULO;
 ...
 RETANGULO cria_retangulo(int id, float x, float y, float largura, float altura, char* corP, char* corB);
